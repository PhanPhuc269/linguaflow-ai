...
export default function Lessons() {
  ...
  >({
    queryKey: ["topics"],
    queryFn: async () => {
      const res = await lessonService.getUserTopics();
  ...
  >({
    ...
    queryFn: () => lessonService.getTopicsLessons(selectedTopic),
    enabled: !!selectedTopic,
  });

  useEffect (() => {
    setLessons(lessonsData);
  }, [selectedTopic, lessonsData]);
          ...
          <div className="p-4 border-t border-border">
            <div className="bg-muted/50 rounded-xl p-4">
              ...
              <div className="flex items-end gap-2">
                ...
                <span className="text-muted-foreground mb-1">/ {lessons.length} bài</span>
              </div>
